...
public class DBManager {
    ...
    public void init(){
        open();
        insert(new DbAdModel(1, "crescentcity3", "Raspberry pi 0W", "Carte Raspberry pi neuve, jamais utilisée, datant de 2020", 20, "Informatique", "Mathias", "8 Rue Colbrant, 59000 Lille", 645784922, "mathiasribeiro62@free.fr", "True"));
