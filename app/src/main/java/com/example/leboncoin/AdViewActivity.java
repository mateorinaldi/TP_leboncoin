...
public class AdViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView description = findViewById(R.id.description_adView);
        ImageView image = findViewById(R.id.image_adview);
        TextView category = findViewById(R.id.category_adview);
        TextView seller = findViewById(R.id.Seller_adView);
        TextView email = findViewById(R.id.mail_adView);
        TextView telephone = findViewById(R.id.telephone_adView);
        ...
        String cate = i.getStringExtra("category");
        String sell = i.getStringExtra("seller");
